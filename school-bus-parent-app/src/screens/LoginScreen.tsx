...
type Props = { navigation: StackNavigationProp<ParentStackParamList, 'Login'> };
          ...
          <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
            <View style={{ alignItems: 'center', marginBottom: 48 }}>
              <View style={{
                ...
                shadowColor: '#10B981', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.4, shadowRadius: 20,
            ...
            <View style={{
              ...
              {step === 'phone' ? (
                <>
                  <TextInput
                    ...
                    placeholder="+1 000 000 0004" placeholderTextColor="#475569"
                    ...
                    autoFocus
                  />
                  <TouchableOpacity onPress={handleSendOtp} disabled={loading} style={{
                ...
                <>
                  <Text style={{ color: '#64748B', fontSize: 13, marginBottom: 12 }}>OTP sent to {phone}</Text>
                  <TextInput
                    value={otp} onChangeText={setOtp}
                    placeholder="123456" placeholderTextColor="#475569" keyboardType="number-pad" maxLength={6}
                    style={{
                      backgroundColor: '#1E293B', color: '#F8FAFC', borderRadius: 14,
                      paddingHorizontal: 18, paddingVertical: 16, fontSize: 24, fontWeight: '800',
                      borderWidth: 1, borderColor: '#334155', marginBottom: 16, letterSpacing: 8, textAlign: 'center',
                    }}
                    autoFocus
                  />
                  <TouchableOpacity onPress={handleVerifyOtp} disabled={loading} style={{
                    backgroundColor: '#10B981', borderRadius: 14, paddingVertical: 16,
                    alignItems: 'center', opacity: loading ? 0.7 : 1,
                  }}>
                    {loading ? <ActivityIndicator color="#fff" /> : <Text style={{ color: '#fff', fontSize: 16, fontWeight: '700' }}>Verify & Sign In</Text>}
                  </TouchableOpacity>
              ...
              {error ? <Text style={{ color: '#F87171', fontSize: 13, marginTop: 12, textAlign: 'center' }}>{error}</Text> : null}
            </View>
          </Animated.View>
        </View>
      </LinearGradient>
